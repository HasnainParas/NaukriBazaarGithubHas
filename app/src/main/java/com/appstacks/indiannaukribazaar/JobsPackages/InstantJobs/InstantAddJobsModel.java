...
public class InstantAddJobsModel {
    ...
    String inJobTitle, inJobDes, inJobPosition, inJobBudget, inJobCompany, inJobTimePeriod,inJobID,userAuthID;
    String PostedDate;
    ...
    public InstantAddJobsModel(String inJobTitle, String inJobDes, String inJobPosition, String inJobBudget, String inJobCompany, String inJobTimePeriod, String inJobID, String userAuthID, String postedDate) {
